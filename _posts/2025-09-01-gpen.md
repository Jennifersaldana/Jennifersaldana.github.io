...
Book,    Topic,    Comments
2.114 /etc/password Linux file, world-readable and can be viewed to see a list of user accounts
4.39  GetUserSPN.py  gets a list of Server Principal Names
...
_________
On the actual exam, I got a 92%. I believe actually completing the lab, fixing my index, watch the videos on sections I needed help on, and keeping track of my time was the solution. I didn't study the day before and just printed both of indexes, any sheets GIAC provides, and collected all the books. 
